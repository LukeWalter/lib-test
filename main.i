...
void initialize() {
    ...
    DMANow(3, ssPal, ((unsigned short*) 0x5000200), 512 / 2);
    DMANow(3, ssTiles, ((CB*) 0x06010000), 32768 / 2);
...
void drawGame() {
    ...
    sprite.attributes->attr0 = ((sprite.worldY) & 0xFF) | (((SQUARE) & 3) << 14);
    sprite.attributes->attr1 = ((sprite.worldX) & 0x1FF) | (((SMALL) & 3) << 14);
    sprite.attributes->attr2 = (((sprite.currFrame * 2)) * (32) + ((sprite.aniState * 2)));

    if ((~(*(volatile unsigned short*) 0x04000130) & ((1 << 0)))) {
        sprite.attributes->attr0 |= (((DOUBLEAFFINE) & 3) << 8);
        sprite.attributes->attr1 |= (((sprite.affineMatrix) & 31) << 9);
